...
// Practice
// 1. Calculate how much deposit have in all bank accounts
const bankDepositSum = accounts
  .flatMap((acc) => acc.movements)
  .filter((mov) => mov > 0)
  .reduce((sum, cur) => sum + cur, 0);

// 2. Count how much deposit have with at least 1000$
// Easy way solution
...
// 3. Find how much deposits have and how much withdrawals
// One way solution:
